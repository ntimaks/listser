...
export type Item = {
  ...
  created_by: string;
  // Optional fields added in 0005. Null on grocery rows; used by wishlist
...
export function useListItems(
  ...
  // Remove items outright — used by "Clear completed" / "Clear acquired"
  // (todo/wishlist). Grocery clears via finishTrip/record_trip instead.
